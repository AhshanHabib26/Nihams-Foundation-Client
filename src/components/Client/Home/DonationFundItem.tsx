...
const DonationFundItem = () => {
  ...
  return (
    <div className="my-10">
      <Container>
        <div>
          <h1 className="text-center text-2xl font-semibold text-gray-700 mb-8">Together, we create a better tomorrow.</h1>
          ...
          <div>
            <div className="flex justify-center mt-8">
              <Link to="/donate" className="text-green-600 hover:underline">View All Funds</Link>
            </div>
          </div>
        </div>
      </Container>
